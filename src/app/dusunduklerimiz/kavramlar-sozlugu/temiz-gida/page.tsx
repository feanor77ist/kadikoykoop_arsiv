...
export default function TemizGida() {
      ...
      <div className="relative z-10">
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 overflow-x-hidden">
          <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-8 break-words flex-wrap">
            ...
            <span>/</span>
            <span className="text-gray-900 dark:text-white font-medium">Temiz Gıda</span>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-8 shadow-sm border border-gray-200 dark:border-gray-700 space-y-6 break-words overflow-x-hidden">
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Temiz gıda derken en başta tohumun temizliğinden bahsetmek gerekir ki bu da hibrit, GDO tohumla üretilen değil atalık tohumlarla üretilendir.
            </p>

            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Tohumdan sonra gıdanın ilaçlanmamış olması gerekmektedir. Tarım ilaçları insan vücudu için büyük ölçekte zararlıdır. Bir gıda ürünün temiz olması için mumlanmamış, (meyve çürümesini geciktirmek ve meyve kabuklarını parlatmak amacıyla ince bir parafin tabakasıyla kaplanması işlemi) ışınlanmamış, (kuruyemiş ve kuru baklagillerde böceklenmeyi engellemek, patatesin filizlenmesini önlemek, tohumların çimlenmesini önlemek, et, tavuk, balık ürünlerinin raf ömrünü uzatmak gibi sebeplerle uygulanan işlem) ve son olarak da kimyasala bulanmamış (üretim, işleme, taşıma, hazırlama ve tüketim aşamalarının herhangi bir noktasında bulanan) olması gerekmekted.
            </p>

            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Temiz gıda için kısaca üretiminden tüketimine kadar olan aşamada kimyasal girdinin olmadığı, atalık tohumla üretilen gıda tanımı yapılabilir.
            </p>
          </div>
