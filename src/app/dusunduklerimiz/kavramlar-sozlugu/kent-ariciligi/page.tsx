...
export default function KentAriciligi() {
      ...
      <div className="relative z-10">
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 overflow-x-hidden">
          <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-8 break-words flex-wrap">
            ...
            <span>/</span>
            <span className="text-gray-900 dark:text-white font-medium">Kent Arıcılığı</span>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-8 shadow-sm border border-gray-200 dark:border-gray-700 space-y-6 break-words overflow-x-hidden">
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Kent arıcılığı, şehir içinde ve çevresinde arı yetiştiriciliği yapılmasıdır. Kentsel alanlarda arıcılık faaliyetleri, kırsal alanlardaki geleneksel arıcılıktan farklı olarak şehir koşullarına uygun şekilde yapılır.
            </p>

            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Kent arıcılığı, şehirlerdeki parklar, bahçeler, balkonlar ve çatılarda arı kovanları kurularak gerçekleştirilebilir. Bu uygulama hem arılar için şehirdeki çiçekli bitkilerden nektar toplama imkanı sağlar, hem de kentsel ekosisteme katkıda bulunur.
            </p>

            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Kent arıcılığı, kentlilerin doğayla bağlantı kurmasını, biyoçeşitliliğin korunmasına katkı sağlamasını ve yerel bal üretimine destek olmasını sağlar. Ayrıca, arıların tozlaşma faaliyetleri kentteki bitki örtüsünün sağlığına ve çeşitliliğine katkıda bulunur.
            </p>
          </div>
