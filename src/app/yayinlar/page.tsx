...
export default function Yayinlar() {
  const subSections = [
    {
      id: "kooperatifi-anlatan-yazilar",
      title: "Kooperatifi Anlatan Yazılar",
      description: "Kadıköy Kooperatifi hakkında yazılmış yazılar ve medyada çıkan haberler",
      href: "/yayinlar/kooperatifi-anlatan-yazilar",
      icon: "📰"
    }
  ];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400">
            Yayınlar ve medyada çıkan haberler
          </p>
        </div>
