...
export default function Bolum9() {
  const subSections = [
    {
      id: "a",
      title: "Kooperatifi Anlatan Yazılar",
      description: "Çeşitli dergilerde ve yayınlarda Kadıköy Kooperatifi hakkında çıkan yazılar",
      href: "/yayinlar/a",
      icon: "✍️"
    },
    {
      id: "b",
      title: "Medyada Çıkanlar",
      description: "Gazete, dergi ve çevrimiçi platformlarda kooperatif haberleri",
      href: "/yayinlar/b",
      icon: "📰"
    }
  ];
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400">
            Basında ve medyada Kadıköy Kooperatifi
          </p>
        </div>
