...
export default function EkolojiKolektifiRoportaji() {
      ...
      <div className="relative z-10">
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 overflow-x-hidden">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-8 break-words flex-wrap">
            ...
            <span>/</span>
            <span className="text-gray-900 dark:text-white font-medium">Ekoloji Kolektifi Röportajı</span>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-8 shadow-sm border border-gray-200 dark:border-gray-700 space-y-6 break-words overflow-x-hidden">
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              <strong>1) Kadıköy Kooperatifi son 3 yıldır yoğun bir çalışma içindeydi ve geçtiğimiz kasım ayında da bir dükkan açtı. Kooperatife ilgi geçmiş süreci kısaca anlatabilir misin?</strong>
            </p>

            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Kadıköy Kooperatifi, İstanbul'un Kadıköy ilçesinde bir kooperatif kurma fikriyle yan yana gelmiş kişilerin oluşturduğu bir inisiyatif olarak 2014 yılında çalışmalarına başladı. Kasım Ekim 2016 yılında tüketim kooperatifi tüzel kişiliğini aldı ve ilk kooperatif dükkanını açtı.
            </p>

            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Kadıköy Kooperatifi fikrinin temelleri, Gezi direnişi sonrasında oluşan park, mahalle, üniversite ve iş yeri forum ve dayanışmaları döneminde, Kadıköy ilçesindeki mevcut forumlarda yapılan tartışmalarda ortaya çıktı. Forum ve Dayanışmalar'ın geri çekilmesi sonrasında bağımsızlaşan kooperatif çalışmasının tarihini 4 aşamada ifade etmek mümkün.
            </p>

            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              İlk olarak, Mahalle Dayanışmaları Döneminde fikir ortaya atıldı. Sonrasında Kooperatif Çalışma Grubu kuruldu ve tartışmaları ve çalışmaları koordine etme görevi üstlendi. Kadıköy'de bulunan dayanışma ve forumlarının katılımı ve organizasyonu ile Çiftçi Sendikaları Konfederasyonu (ÇİFTÇİ-SEN), Boğaziçi Mensupları Tüketim Kooperatifi (BÜKOOP), Tohum İzi Derneği ve Anadolu'da Yaşam Kooperatifi'nin katılımı ile 1 Şubat 2014'de bir çalıştay düzenlendi. Kooperatif için Kadıköy ölçeğine uygun, bahsettiğimiz kurumların deneyimlerinden de faydalanarak bir model oluşturuldu. Lakin Kooperatif hemen o zaman çalışmalarını somutlayamadı. Bir süre ara verildi. Sonbahar'da tekrar yan yana gelindi. Yeni bir grup olarak çalışmalar yeniden başladı. Mevcut birikim, tartışma ve deneyimlere istinaden bir takım ortak ilkeler oluşturuldu ve bizim "sipariş paketleri" diye ifade ettiğimiz dönem başladı. 2015 Mart ayı ile 2016 yaz başına kadar 5 sefer sipariş paketi organizasyonu yaptık. Bu süreçte, Kadıköy'deki temaslarımızı güçlendirdik, kooperatif fikrini olgunlaştırdık, tartıştık, yaygınlaştırdık. Pratikte tecrübe ettik. Resmi bir kooperatif kurmak için düşünsel ve pratik olarak kendimizi hazırlamış olduk. 2016 Ekim Kasım ayı itibariyle resmi bir kooperatifiz, bir dükkanımız var. Çalışmalarımıza bu şekilde devam ediyoruz.
            </p>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-8">
              <strong>2) Çalışmalarınız ne aşamada? kaç kişi çalışıyor, kaç ortağı var? Gönüllü desteklerin kapsamı nedir?</strong>
            </p>

            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Şu an 16 resmi ortağımız bulunuyor; 20-25 kişilik de aktif çalışmalara katılan bir grubumuz var. Ayrıca dışarıdan çalışmalarımıza katkı koyan kooperatif dostlarımız var. Çekirdek grubumuz çok küçük bir sayı ile başladı, kendisini yenileyen ve geliştiren bir şekilde bu sayıya ulaştı. Yeni gelen ile eskiden beri çalışmanın içinde olan kişiler arasındaki farkı gidermek için sürekli öğrenme, birbirini destekleme, güçlendirme yöntemleri kullanıyoruz. Gönüllülüğün başında, buna açık olmak, öğrenmeye ve beraber çalışmaya "gönlü olmak" geliyor, diyebiliriz.
            </p>

            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Çünkü, bir gönüllünün kooperatifte yapabileceği herhangi bir şey, örneğin toplantılara katılmak, karar vermek ve karşılıklı sorumluluk almak, alınan görevleri uygulamak; örneğin zeytinleri paketlemek, alışverişe gelen kişilere güleryüzlü davranmak, bir ürün bittiğinde üreticiyi aramak, kargo görevlisini karşılamak; apartmandaki ve mahalledeki komşulara günaydın demek; başka bir kooperatif çalışması için farklı ilçelere gitmek, yeni insanlarla tanışmak... Bunlara gönlünüz olmadığı zaman yapamazsınız. Başka insanlarla temas kurmak, onları yaptığınız çalışmanın parçası kılmak; en önemlisi de, hakikaten iyi bir şeyler yaptığınızı anlatabilmek gerekir. Buna gönül (gönüllü desek daha iyi ifade etmez mi?) olmak, bunu göze almak gerekir.
            </p>

            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-8">
              <strong>3) Ortakları dışındaki kişilerle- tüketicilerle nasıl iletişim kuruyor kooperatif?</strong>
            </p>

            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Her hafta düzenli toplantılar yapıyoruz. Bizi tanımak isteyenler toplantılarımıza gelebiliyor. Ayrıca, Kooperatif Dükkanı haftanın her günü açık; alış veriş yapmaya veya çay içmeye gelinebiliyor. Her ayın son Cuması "Kooperatif Kendisini Anlatıyor" başlıklı tanışma toplantıları düzenliyoruz. Ayrıca, düzenli olmasa da, atölyeler, paneller, söyleşiler düzenliyor, bunları da olabildiğince mahalle temelli yapmaya çalışıyoruz. Şu ana kadar Caferağa, Osmanağa, Yeldeğirmeni, Caddebostan mahallelerinde etkinlikler yaptık. Bunları yaygınlaştırmaya çalışıyoruz.
            </p>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-8">
              <strong>4) Metropol hayatı içinde Kooperatiften alış verişi tercih etmekte zorlanıyor mu insanlar? Sanal ortamdan da mı ulaşıyorlar size?</strong>
            </p>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-8">
              <strong>5) Kadıköy gibi semtlerde mahalle kültürünün giderek ön plana çıktığı gibi bir söylem var, buna katılır mısınız? Mahalle kültürü ile kooperatif arasında bir ilişki var mı sizce?</strong>
            </p>

            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Öncelikle, Kadıköy Türkiye'nin en kalabalık ilçelerinden biri (2016 nüfus bilgilerine göre 452.302). Dolayısıyla bu tarz bir çalışma yapmanın belirli avantajları ve dezavantajları olduğunu söylemek gerekir. Yerleşik yapısının geçtiğimiz bir kaç sene içerisinde çok hızlı değiştiği söylenebilir. Bir ikincisi, yine belirttiğimiz üzere Kadıköy gün içerisinde çok fazla kişinin gelip geçtiği, çalıştığı, eşi dostuyla buluştuğu, gezdiği, bir ilçe. Bu açıdan yerleşik nüfusu ile burada nefes alan insanların sayısı arasında ciddi bir fark var.
            </p>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-8">
              <strong>6) Tabi Kadıköy'de de yoğun bir kentsel dönüşüm yaşanıyor, yeni orta sınıfların tüketim alışkanlıkları ile doğal üretim tarzları arasında nasıl bir ilişki kuruyorsunuz?</strong>
            </p>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-8">
              <strong>7) Kadıköy Kooperatifi gibi bir kooperatif kurmak isteyen tüketiciler ne yapmalı?</strong>
            </p>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-8">
              <strong>8) Üretici ve tüketicilerin kooperatifler aracılığıyla aracısız buluşmasını sağlayan yöntemler temiz gıdanın güvencesi olabilir mi? Neden? Nasıl?</strong>
            </p>
