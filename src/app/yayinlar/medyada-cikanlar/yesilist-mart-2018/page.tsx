...
export default function YesilistMart2018() {
      ...
      <div className="relative z-10">
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 overflow-x-hidden">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-8 break-words flex-wrap">
            ...
            <span>/</span>
            <span className="text-gray-900 dark:text-white font-medium">Yeşilist Röportaj - Mart 2018</span>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-8 shadow-sm border border-gray-200 dark:border-gray-700 space-y-6 break-words overflow-x-hidden">
            <div className="space-y-6">
              <div className="relative w-full">
                <img
                  src="/medya-haberleri/2018/yesilist-roportaj-2018-mart-1.webp"
                  alt="Yeşilist Röportaj - Sayfa 1"
                  className="w-full h-auto rounded-lg shadow-md"
                />
              </div>
              <div className="relative w-full">
                <img
                  src="/medya-haberleri/2018/yesilist-roportaj-2018-mart-2.webp"
                  alt="Yeşilist Röportaj - Sayfa 2"
                  className="w-full h-auto rounded-lg shadow-md"
                />
              </div>
              <div className="relative w-full">
                <img
                  src="/medya-haberleri/2018/yesilist-roportaj-2018-mart-3.webp"
                  alt="Yeşilist Röportaj - Sayfa 3"
                  className="w-full h-auto rounded-lg shadow-md"
                />
              </div>
              <div className="relative w-full">
                <img
                  src="/medya-haberleri/2018/yesilist-roportaj-2018-mart-4.webp"
                  alt="Yeşilist Röportaj - Sayfa 4"
                  className="w-full h-auto rounded-lg shadow-md"
                />
              </div>
              <div className="relative w-full">
                <img
                  src="/medya-haberleri/2018/yesilist-roportaj-2018-mart-5.webp"
                  alt="Yeşilist Röportaj - Sayfa 5"
                  className="w-full h-auto rounded-lg shadow-md"
                />
              </div>
              <div className="relative w-full">
                <img
                  src="/medya-haberleri/2018/yesilist-roportaj-2018-mart-6.webp"
                  alt="Yeşilist Röportaj - Sayfa 6"
                  className="w-full h-auto rounded-lg shadow-md"
                />
              </div>
              <div className="relative w-full">
                <img
                  src="/medya-haberleri/2018/yesilist-roportaj-2018-mart-7.webp"
                  alt="Yeşilist Röportaj - Sayfa 7"
                  className="w-full h-auto rounded-lg shadow-md"
                />
              </div>
              <div className="relative w-full">
                <img
                  src="/medya-haberleri/2018/yesilist-roportaj-2018-mart-8.webp"
                  alt="Yeşilist Röportaj - Sayfa 8"
                  className="w-full h-auto rounded-lg shadow-md"
                />
              </div>
              <div className="relative w-full">
                <img
                  src="/medya-haberleri/2018/yesilist-roportaj-2018-mart-9.webp"
                  alt="Yeşilist Röportaj - Sayfa 9"
                  className="w-full h-auto rounded-lg shadow-md"
                />
              </div>
            </div>
