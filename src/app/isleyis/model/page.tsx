...
export default function Bolum4() {
  const subSections = [
    {
      id: "a",
      title: "Kooperatif Modeli",
      description: "Kooperatif modeli ve çalışma biçimi (2019)",
      href: "/isleyis/a",
      icon: "🏗️"
    },
    {
      ...
      description: "Kooperatif birimlerinin yönergeleri ve sorumlulukları",
      href: "/isleyis/b",
      icon: "📋"
    }
  ];
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400">
            Kooperatifin organizasyonu ve çalışma modeli
          </p>
        </div>
