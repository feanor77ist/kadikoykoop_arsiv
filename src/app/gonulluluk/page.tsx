...
export default function Gonulluluk() {
  ...
  const subSections = [
    {
      id: "egitim-envanteri",
      title: t('sections.egitim-envanteri.title'),
      description: t('sections.egitim-envanteri.description'),
      href: "/gonulluluk/egitim-envanteri",
      icon: "📋"
    },
    {
      id: "egitim-sunumu",
      title: t('sections.egitim-sunumu.title'),
      description: t('sections.egitim-sunumu.description'),
