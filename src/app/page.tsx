    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 relative">
      ...
      <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-30 flex flex-col gap-2 sm:gap-3">
        <a
          ...
          className="bg-white dark:bg-gray-800 rounded-full p-2 sm:p-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 border border-gray-200 dark:border-gray-700"
        ...
        >
          <svg
            className="w-5 h-5 sm:w-6 sm:h-6 text-gray-900 dark:text-gray-100"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <a
          href="https://youtube.com/@kadkoykooperatifi9993?si=0qsJZt9JWxBZQFE6"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-white dark:bg-gray-800 rounded-full p-2 sm:p-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 border border-gray-200 dark:border-gray-700"
          aria-label="YouTube"
